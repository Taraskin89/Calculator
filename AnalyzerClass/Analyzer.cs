...
namespace AnalyzerClass
{
    public class Analyzer
    {
        ...
        public static string Expression = "0";
        ...
        public static bool CheckCurrency()
        {
            try
            {
                ...
                Expression = Expression.Replace(" 0 ", string.Empty);
                ...
                //if ("-2147483648" >= Expression ||  "2147483647".Equals(Expression + 1))
                //{
                 //   ShowMessage = true;
                   // Expression = "Error 06";
                    //return false;
        ...
        public static string Format()
        {
            for (int i = 0; i < Expression.Length; i++)
            {
                ...
                if ("()+-mp%*/".Contains(Expression[i])) Expression = Expression.Insert(i - 2, " ");
